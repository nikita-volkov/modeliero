module Modeliero.Codegens.Haskell.ModuleTemplates.ProductModel.Templates.ToJsonInstanceSpec where

import Coalmine.Prelude
import Modeliero.Codegens.Haskell.ExtrasFor.Hspec
import Modeliero.Codegens.Haskell.ModuleTemplates.ProductModel.Templates.ToJsonInstance qualified as Subject
import Test.Hspec
