module Modeliero.Codegens.Haskell.ModuleTemplates.ProductModel.Templates.FromJsonInstanceSpec where

import Coalmine.Prelude
import Modeliero.Codegens.Haskell.ExtrasFor.Hspec
import Modeliero.Codegens.Haskell.ModuleTemplates.ProductModel.Templates.FromJsonInstance qualified as Subject
import Test.Hspec
