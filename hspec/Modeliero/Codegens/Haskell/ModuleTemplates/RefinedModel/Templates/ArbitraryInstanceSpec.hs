module Modeliero.Codegens.Haskell.ModuleTemplates.RefinedModel.Templates.ArbitraryInstanceSpec where

import Coalmine.Prelude
import Modeliero.Codegens.Haskell.ExtrasFor.Hspec
import Modeliero.Codegens.Haskell.ModuleTemplates.RefinedModel.Templates.ArbitraryInstance qualified as Subject
import Test.Hspec
