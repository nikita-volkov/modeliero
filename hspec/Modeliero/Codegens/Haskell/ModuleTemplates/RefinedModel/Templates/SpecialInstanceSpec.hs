module Modeliero.Codegens.Haskell.ModuleTemplates.RefinedModel.Templates.SpecialInstanceSpec where

import Coalmine.Prelude
import Modeliero.Codegens.Haskell.ExtrasFor.Hspec
import Modeliero.Codegens.Haskell.Imports qualified as Imports
import Modeliero.Codegens.Haskell.ModuleTemplates.RefinedModel.Templates.SpecialInstance qualified as Subject
import Test.Hspec
    ...
    describe "Month" do
      ...
      compilingProducesExpectedContent Subject.compile params
        $ [i|
            ...
            instance ModelieroBase.Special Month where
    ...
    describe "Phone" do
      ...
      compilingProducesExpectedContent Subject.compile params
        $ [i|
            ...
            instance ModelieroBase.Special Phone where
