module Modeliero.Codegens.Haskell.Templates.ProductModelModule.Templates.ProductModelModuleSpec where

import Coalmine.Prelude
import Modeliero.Codegens.Haskell.ExtrasFor.Hspec
import Modeliero.Codegens.Haskell.Templates.ProductModelModule.Templates.ProductModelModule qualified as Subject
import Test.Hspec
