...
module Modeliero.Codegens.Haskell.Templates.ProxyModelModule
  ( Params (..),
    Result,
    compile,
  )
...
import Modeliero.Codegens.Haskell.Templates.ProxyModelModule.Templates.IsomorpicToInstances qualified as Templates.IsomorpicToInstances
